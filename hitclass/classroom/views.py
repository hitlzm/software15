...
def reserveinfo(request):
	...
	if request.POST:
		...
		return render_to_response('reserveinfo.html', {'classroomMessage':classroomMessage, 'username':user.username})

	return render_to_response('reserveinfo.html', {'username':user.username})
